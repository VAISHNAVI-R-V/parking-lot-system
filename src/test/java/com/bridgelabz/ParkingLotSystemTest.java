...
public class ParkingLotSystemTest {
    ...
    void givenAVehicle_WhenParked_ShouldReturnTrue() throws ParkingLotSystemException {
        Vehicle vehicle = new Vehicle("KA-2580", "Black",
                "Audi", "20:30", Vehicle.Size.LARGE);
    ...
    void givenAVehicle_WhenAlreadyParked_ShouldReturnFalse() throws ParkingLotSystemException {
        Vehicle vehicle = new Vehicle("KA-2640", "Black",
                "Audi", "9:25", Vehicle.Size.LARGE);
        parkingLotSystem.parkVehicle(vehicle, Vehicle.DriverType.NORMAL);
    ...
    void givenAVehicle_WhenUnParked_ShouldReturnFalse() throws ParkingLotSystemException {
        Vehicle vehicle1 = new Vehicle("KA-3280", "Silver",
                "KIA", "7:30", Vehicle.Size.LARGE);
        parkingLotSystem.parkVehicle(vehicle1, Vehicle.DriverType.NORMAL);
    ...
    void givenAVehicle_WhenUnParkedFromEmptySlot_ShouldReturnFalse() {
        Vehicle vehicle = new Vehicle("IN-4586", "Marron",
                "Porsche", "16:00", Vehicle.Size.LARGE);
        boolean isUnParked = parkingLotSystem.isVehicleUnParked(vehicle);
    ...
    void givenAVehicle_WhenUnParkedAnotherVehicle_ShouldReturnFalse() throws ParkingLotSystemException {
        Vehicle vehicle1 = new Vehicle("MH-2021", "Red",
                "Ford", "6:15", Vehicle.Size.LARGE);
        Vehicle vehicle2 = new Vehicle("MH-2020", "Yellow",
                "Alto", "14:15", Vehicle.Size.LARGE);
        parkingLotSystem.parkVehicle(vehicle1, Vehicle.DriverType.NORMAL);
    ...
    public void givenAVehicle_WhenParkingLotIsFull_ShouldInformTheOwner() {
        ...
        Vehicle vehicle1 = new Vehicle("KA-3690", "Brown",
                "Toyota", "13:50", Vehicle.Size.LARGE);
        Vehicle vehicle2 = new Vehicle("KA-8520", "Grey",
                "Fiat", "3:35", Vehicle.Size.LARGE);
        Vehicle vehicle3 = new Vehicle("MH-3214", "Blue",
                "Tata", "4:00", Vehicle.Size.LARGE);
        Vehicle vehicle4 = new Vehicle("MH-7895", "White",
                "Lexus", "18:00", Vehicle.Size.LARGE);
        Vehicle vehicle5 = new Vehicle("MH-7095", "White",
                "BMW", "18:10", Vehicle.Size.LARGE);
        Assertions.assertThrows(ParkingLotSystemException.class, () -> {
            parkingLotSystem.parkVehicle(vehicle1, Vehicle.DriverType.NORMAL);
            parkingLotSystem.parkVehicle(vehicle2, Vehicle.DriverType.NORMAL);
            parkingLotSystem.parkVehicle(vehicle3, Vehicle.DriverType.NORMAL);
            parkingLotSystem.parkVehicle(vehicle4, Vehicle.DriverType.NORMAL);
            parkingLotSystem.parkVehicle(vehicle5, Vehicle.DriverType.NORMAL);
        }, "Parking Lot is Full");
    }
    ...
    void givenAVehicle_WhenParkingLotIsFull_ShouldInformTheSecurity() {
        ...
        Vehicle vehicle1 = new Vehicle("KA-5710", "Red",
                "Maruti Suzuki", "2:45", Vehicle.Size.LARGE);
        Vehicle vehicle2 = new Vehicle("KA-5510", "Red",
                "BMW", "1:45", Vehicle.Size.LARGE);
        Vehicle vehicle3 = new Vehicle("KA-5210", "White",
                "Alto", "4:05", Vehicle.Size.LARGE);
        Vehicle vehicle4 = new Vehicle("KA-5730", "Red",
                "Maruti Suzuki", "14:45", Vehicle.Size.LARGE);
        Vehicle vehicle5 = new Vehicle("MH-4814", "Black",
                "Nano", "2:00", Vehicle.Size.LARGE);
        Assertions.assertThrows(ParkingLotSystemException.class, () -> {
            parkingLotSystem.parkVehicle(vehicle1, Vehicle.DriverType.NORMAL);
            parkingLotSystem.parkVehicle(vehicle2, Vehicle.DriverType.NORMAL);
            parkingLotSystem.parkVehicle(vehicle3, Vehicle.DriverType.NORMAL);
    ...
    void givenWhenParkingLotSpaceAvailableAfterFull_ShouldReturnTrue() throws ParkingLotSystemException {
        parkingLotSystem.registerParkingLotObserver(owner);
        Vehicle vehicle1 = new Vehicle("MH-8595", "Silver",
                "Hyundai", "5:15", Vehicle.Size.LARGE);
        Vehicle vehicle2 = new Vehicle("KA-9614", "Blue",
                "BMW", "11:45", Vehicle.Size.LARGE);
        Vehicle vehicle3 = new Vehicle("KA-9654", "Blue",
                "BMW", "5:45", Vehicle.Size.LARGE);
        Vehicle vehicle4 = new Vehicle("KA-9023", "Orange",
                "Kia", "1:30", Vehicle.Size.LARGE);
        Vehicle vehicle5 = new Vehicle("KA-6423", "Orange",
                "alto", "1:20", Vehicle.Size.LARGE);
        Assertions.assertThrows(ParkingLotSystemException.class, () -> {
            parkingLotSystem.parkVehicle(vehicle1, Vehicle.DriverType.NORMAL);
            parkingLotSystem.parkVehicle(vehicle2, Vehicle.DriverType.NORMAL);
            parkingLotSystem.parkVehicle(vehicle3, Vehicle.DriverType.NORMAL);
    ...
    void givenAVehicle_WhenFound_DriverCanGoHome() throws ParkingLotSystemException {
        Vehicle vehicle1 = new Vehicle("IN-9771", "Silver",
                "BMW", "12:30", Vehicle.Size.LARGE);
        parkingLotSystem.parkVehicle(vehicle1, Vehicle.DriverType.NORMAL);
    ...
    void givenAVehicleToAttendant_WhenParked_ShouldReturnTrue() throws ParkingLotSystemException {
        Vehicle vehicle = new Vehicle("KA-9671", "Black",
                "Scorpio", "12:00", Vehicle.Size.LARGE);
    ...
    void givenAVehicle_WhenParked_ShouldParkedVehicleEvenly() throws ParkingLotSystemException {
        Vehicle vehicle1 = new Vehicle("IN-5211", "White",
                "Toyota", "9:35", Vehicle.Size.LARGE);
        Vehicle vehicle2 = new Vehicle("IN-5281", "White",
                "BMW", "9:25", Vehicle.Size.LARGE);
        parkingLotSystem.parkVehicle(vehicle1, Vehicle.DriverType.NORMAL);
        parkingLotSystem.parkVehicle(vehicle2, Vehicle.DriverType.NORMAL);
    ...
    public void givenAVehicle_WhenParked_ShouldReturnThePositionOfWhiteColorVehicle() throws ParkingLotSystemException {
        Vehicle vehicle1 = new Vehicle("KA-2654", "White",
                "BMW", "5:45", Vehicle.Size.LARGE);
        Vehicle vehicle2 = new Vehicle("KA-1023", "Orange",
                "Kia", "1:30", Vehicle.Size.LARGE);
        parkingLotSystem.parkVehicle(vehicle1, Vehicle.DriverType.NORMAL);
    ...
    public void givenAVehicle_WhenParked_ShouldReturnThePositionOfToyotaBlueColorVehicle()
        ...
        Vehicle vehicle1 = new Vehicle("KA-1023", "Blue",
                "Toyota", "1:30", Vehicle.Size.LARGE);
        Vehicle vehicle2 = new Vehicle("KA-1023", "Orange",
                "Kia", "1:30", Vehicle.Size.LARGE);
        parkingLotSystem.parkVehicle(vehicle1, Vehicle.DriverType.NORMAL);
    ...
    public void givenAVehicle_WhenParked_ShouldReturnThePositionOfToyotaBlueColorVehicleWithNumberPlate()
            throws ParkingLotSystemException {
        Vehicle vehicle1 = new Vehicle("KA-2221", "Blue",
                "Toyota", "6:15", Vehicle.Size.LARGE);
        Vehicle vehicle2 = new Vehicle("MH-2020", "Yellow",
                "Alto", "14:15", Vehicle.Size.LARGE);
        parkingLotSystem.parkVehicle(vehicle1, Vehicle.DriverType.NORMAL);
    ...
    public void givenAVehicle_WhenParked_ShouldReturnBMWVehicle()
            throws ParkingLotSystemException {
        Vehicle vehicle1 = new Vehicle("KA-2561", "Blue",
                "BMW", "7:05", Vehicle.Size.LARGE);
        Vehicle vehicle2 = new Vehicle("MH-2620", "Yellow",
                "Alto", "6:45", Vehicle.Size.LARGE);
        parkingLotSystem.parkVehicle(vehicle1, Vehicle.DriverType.NORMAL);
    ...
    void givenHandicappedVehicleParked_whenChecked_shouldReturnFirstEmptySpot() throws ParkingLotSystemException {
        Vehicle vehicle = new Vehicle("BMW", "HR-26CF2784",
                "Blue", "11:00", Vehicle.Size.LARGE);
        parkingLotSystem.parkVehicle(vehicle, Vehicle.DriverType.NORMAL);
    ...
    void givenHandicapped_whenChecked_returnsParkLot() {
        Vehicle vehicle1 = new Vehicle("IN-9431", "Silver",
                "BMW", "5:25", Vehicle.Size.LARGE);
        parkingLotSystem.parkVehicle(vehicle1, Vehicle.DriverType.NORMAL);
        int lot = parkingLotSystem.findVehicle(vehicle1);
        Assertions.assertEquals(1, lot);
        Vehicle vehicle2 = new Vehicle("IN-8531", "Silver",
                "Ferrari", "5:05", Vehicle.Size.LARGE);
        parkingLotSystem.parkVehicle(vehicle2, Vehicle.DriverType.NORMAL);
    }

    @Test
    void givenVehicle_whenParks_shouldValidatedForNumberPlate() throws ParkingLotSystemException {
        Vehicle vehicle1 = new Vehicle("KA-9654",
                "Blue", "BMW", "5:45", Vehicle.Size.LARGE);
        parkingLotSystem.parkVehicle(vehicle1, Vehicle.DriverType.NORMAL);
